...
var arr = [40,50,60];
//Create a function named 'last' that is given 'arr' as the argument and returns
...
// argument and loops through the given array backwards alerting every item in
// the array starting at the end.

  //Code Here

function reversedLooper(rev) {
...
//array (all the even values from nums) and the second item in the Array being
...
//Above you're given a function that will return a random number between 0 and
//30.  There is also a commented out array full of numbers to help you visualize
//what your function will be receiving.
...
//passed in as a parameter) to see if that random number is in the array. If it
//is, return true, if it's not, return false
...
/*
  ...
  things off of our grocery list, and adding new items to our list.
  ...
  In both the removeItem function and the addItem function, you will also need
  to check for valid aurguments. Specrunner will try to call your functions
  without passing in valid aurguments. When this happens, you will need to
  respond by returning an empty array.
*/
...
//Write a function called maker that creates an array, fills that array with
//numbers from 1 to 215, then returns the array.
...
// arguments. Return the array which is longest.
  ...
  function longer(cat, dog) {
    if(cat.length > dog.length) {
      return cat;
  } else if (dog.length > cat.length) {
    return dog;
  }
}
...
var user2 = {
    name: 'Josdf Sodshgs',
    email: 'ksjdf;as@gmail.com',
    password: 'ksajg;s',
    username: 'oksj'
};

var user3 = {
    name: 'kajsdfas oksajdf',
    email: 'ajksdf;okas@gmail.com',
    password: 'aoasjdf',
    username: 'oajsdf'
};
